...
namespace GamesTan.ECS.Game {
    public static class MathematicsExt {
        ...
        public static Vector2Int ToVecInt2(this int2 vec) => new Vector2Int(vec.x, vec.y);
        public static Vector3Int ToVecInt3(this int2 vec) => new Vector3Int(vec.x, vec.y,0);
        public static Vector3Int ToVecInt3(this int3 vec) => new Vector3Int(vec.x, vec.y,vec.z);
